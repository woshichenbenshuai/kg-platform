...
public class KgBusinessKinderApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(KgBusinessKinderApplication.class);

    private static final String SPRING_APPLICATION_NAME = "spring.application.name";

    public static void main(String[] args) {
        ConfigurableApplicationContext application = SpringApplication.run(KgBusinessKinderApplication.class, args);
