...
public class KgSystemApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(KgSystemApplication.class);

    private static final String SPRING_APPLICATION_NAME = "spring.application.name";

    public static void main(String[] args) {
        ConfigurableApplicationContext application = SpringApplication.run(KgSystemApplication.class, args);
