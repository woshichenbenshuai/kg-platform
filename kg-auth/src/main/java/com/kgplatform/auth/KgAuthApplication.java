...
public class KgAuthApplication {
    ...
    private static final Logger log = LoggerFactory.getLogger(KgAuthApplication.class);

    private static final String SPRING_APPLICATION_NAME = "spring.application.name";

    public static void main(String[] args) {
        ConfigurableApplicationContext application = SpringApplication.run(KgAuthApplication.class, args);
