 ...
 */
@Component
public class AuthCurrentUserInterceptor implements HandlerInterceptor {

    private final ICurrentUserAccessService currentUserAccessService;

    public AuthCurrentUserInterceptor(ICurrentUserAccessService currentUserAccessService) {
