...
(1, '????', 'user_status', '??????', 1, b'0', 'system', NOW(), 'system', NOW()),
(2, '????', 'common_status', '??????', 1, b'0', 'system', NOW(), 'system', NOW())
...
(1, 'user_status', 1, '??', '1', '????', 1, b'0', 'system', NOW(), 'system', NOW()),
(2, 'user_status', 1, '??', '0', '????', 1, b'0', 'system', NOW(), 'system', NOW()),
(3, 'common_status', 2, '??', '1', '????', 1, b'0', 'system', NOW(), 'system', NOW()),
(4, 'common_status', 2, '??', '0', '????', 1, b'0', 'system', NOW(), 'system', NOW())
ON DUPLICATE KEY UPDATE
...
(1, 'PLATFORM_SYSTEM', '????', 'PLATFORM', NULL, '/platform', 'layouts/PlatformLayout.vue', 'Setting', b'1', b'1', 10, '???????', b'1', b'0', 'system', NOW(), 'system', NOW()),
(2, 'PLATFORM_MENU_MGMT', '????', 'PLATFORM', 1, '/platform/menu', 'views/platform/PlatformMenuView.vue', 'Menu', b'1', b'1', 14, '??????', b'1', b'0', 'system', NOW(), 'system', NOW())
ON DUPLICATE KEY UPDATE
...
(1, 'TENANT_DEMO', '????', '???', '13800000000', '??????', '2027-12-31', '??????', b'1', b'0', 'system', NOW(), 'system', NOW())
ON DUPLICATE KEY UPDATE
...
(1, 1, 'mysql', '127.0.0.1', 3306, 'kg_platform', 'root', 'ENC(root)', 'useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai', NULL, 'NORMAL', NOW(), '?????', b'1', b'0', 'system', NOW(), 'system', NOW())
ON DUPLICATE KEY UPDATE
...
(1, 'PLATFORM_ADMIN', '?????', 'PLATFORM', '????????', b'1', b'0', 'system', NOW(), 'system', NOW()),
(2, 'KINDER_ADMIN', '??', 'KINDER', '????????', b'1', b'0', 'system', NOW(), 'system', NOW()),
(3, 'TEACHER_PORTAL', '??', 'KINDER', '????????', b'1', b'0', 'system', NOW(), 'system', NOW()),
(4, 'PARENT_PORTAL', '??', 'KINDER', '????????', b'1', b'0', 'system', NOW(), 'system', NOW())
ON DUPLICATE KEY UPDATE
